...
contract KosCoinCrowdsale is CappedCrowdsale, RefundableCrowdsale {
  ...
  // Constructor
  // ============
  function KosCoinCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet, uint256 _goal, uint256 _cap) CappedCrowdsale(_cap) FinalizableCrowdsale() RefundableCrowdsale(_goal) Crowdsale(_startTime, _endTime, _rate, _wallet) public {
      require(_goal <= _cap);
  }
  // =============
  ...
  function createTokenContract() internal returns (MintableToken) {
    return new KosCoin(); // Deploys the ERC20 token. Automatically called when crowdsale contract is deployed
  }
  // ==================
